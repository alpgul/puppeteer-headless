...
class FakeRequestWindow {
  public static OriginalFunction: originalFunction<[...unknown[]], PictureInPictureEvent, Promise<Window>>;
  public static readonly Type: PatchTypes = PatchTypes.VALUE;
  public static requestWindow(this: PictureInPictureEvent, ...args: [...unknown[]]): Promise<Window | undefined> {
